...
public class DoctorContract extends SymptomManagementContract {
    ...
    public static Doctor readDoctor(final Cursor cursor) {
        ...
        doctor.setDoctorCode(doctorId);
        doctor.setServerId(userId);
        return doctor;
    }

    public static ContentValues getContentValues(final Doctor doctor) {
        final ContentValues contentValues = new ContentValues();
        contentValues.put(DoctorEntry.COLUMN_USER_ID, doctor.getServerId());
        ...
        contentValues.put(DoctorEntry.COLUMN_DOCTOR_ID, doctor.getDoctorCode());
